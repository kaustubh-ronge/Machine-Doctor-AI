...
export default async function AllReportsPage() {
  ...
  return (
    <div className="px-4 sm:px-6 pt-6 space-y-6 animate-in fade-in duration-500 pb-10">
      
      {/* --- HEADER --- */}
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-slate-800 pb-6">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Report Archive</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
            <div className="relative w-full sm:w-64">
                ...
                <Input 
                    ...
                    className="pl-9 bg-slate-900 border-slate-800 text-slate-200 focus:border-blue-500 w-full"
                />
            </div>
            <Button variant="outline" className="border-slate-800 bg-slate-900 text-slate-300 w-full sm:w-auto">
                ...
                <div className="overflow-x-auto">
                    <Table>
                        <TableHeader className="bg-slate-950">
                            ...
                            <TableHead className="text-slate-400 pl-6 min-w-37.5">Machine Name</TableHead>
                            <TableHead className="text-slate-400 min-w-30">Analysis Type</TableHead>
                            <TableHead className="text-slate-400">Health Score</TableHead>
                            <TableHead className="text-slate-400">Risk Assessment</TableHead>
                            <TableHead className="text-slate-400 hidden md:table-cell min-w-30">Date Created</TableHead>
                                ...
                                <TableRow key={report.id} className="border-slate-800 hover:bg-slate-800/50 transition-colors group">
                                    ...
                                    <TableCell className="font-medium text-slate-200 pl-6">
                                        <div className="flex flex-col">
                                            <span className="text-base truncate max-w-37.5 sm:max-w-none">{report.machine.name}</span>
                                    ...
                                    {/* Risk */}
                                    <TableCell>
                                        <Badge variant="outline" className={`${badgeColor} border px-3 whitespace-nowrap`}>
                                            {report.riskLevel}
                                        </Badge>
                                    </TableCell>

                                    {/* Date */}
                                    <TableCell className="hidden md:table-cell text-slate-400 text-sm whitespace-nowrap">
